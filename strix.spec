...
hiddenimports = [
    ...
    'strix.interface.diff_scope',
    'strix.interface.docker_runtime',
    'strix.interface.presentation',
    'strix.interface.targets',
    'strix.agents',
    ...
    'strix.tools.reporting.dependencies',
    'strix.tools.reporting.queries',
    'strix.tools.reporting.vulnerabilities',
