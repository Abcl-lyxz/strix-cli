...
```powershell
uv tool install --upgrade-package strix-agent --reinstall-package strix-agent https://github.com/Abcl-lyxz/strix-cli/releases/download/v1.9.2/strix_agent-1.9.2-py3-none-win_amd64.whl
strix --version
```
